   ...
   <div class="jumbotron">
    ...
    <div class="row">
        ...
        <div class="col-xs-9">
            ...
            <p>You don't think other people's uderstandings as nuts and bolts in that you are yourself of great account and pround as a king inside</p>
            <h3>重点单词:</h3>
            <p><b>nuts and bolts</b></p>
            <hr>
            <h2 id="section-2">第二部分</h2>
            <p>Man proposes , god disposes</p>
            <p>I know life is all about letting go but the saddest part is we don't have even another second to say goodbye</p>
            <hr>
